...
class WtsoScraper(object):
    def __init__(self):
        self.r = requests.get('http://www.wtso.cc/video/vic/eng/season_27?lang=en')
    ...
    def get_desc(self):
        ...
        description = []
        r = requests.get('http://www.imdb.com/title/tt0096697/episodes?season=27')
        data = r.text
        soup = BeautifulSoup(data, 'lxml')
    ...
    def build(self):
        ...
        save_file(database,'data/Season_27.json')
